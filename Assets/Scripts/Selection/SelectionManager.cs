...
namespace SelectionBlob
{
    public class SelectionManager
    {
        ...
        public List<Tile> GetTilesNormalMovement(Tile center, GridManager gridManager)
        {
            ...
            {
                Debug.Log(new Vector2(center.transform.position.x, center.transform.position.z) + direction);
                if (gridManager.TryGetTileAt(new Vector2(center.transform.position.x, center.transform.position.z) + direction, out Tile tile))
                {
